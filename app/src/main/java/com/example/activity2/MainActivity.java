    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (edUser.getText().toString().equals("Annisa")&& !edPass.getText().toString().equals("annisa16")){
                    Toast.makeText((getApplicationContext()), "LOGIN GAGAL || Password Anda salah",
                            Toast.LENGTH_SHORT).show();
                }
                else if (!edUser.getText().toString().equals("Annisa")&& edPass.getText().toString().equals("annisa16")){
                    Toast.makeText((getApplicationContext()), "LOGIN GAGAL || Username Anda salah",
                            Toast.LENGTH_SHORT).show();
                }
                else{
